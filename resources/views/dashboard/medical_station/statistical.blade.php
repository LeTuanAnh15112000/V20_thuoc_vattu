    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">thống kê ({{$medicalStationById->ten_tram_y_te}})</h1>
                    </div>
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item active">thống kê ({{$medicalStationById->ten_tram_y_te}})</li>
                        </ol>
                    </div>
                </div>
            </div>
                        ...
                        <div class="small-box bg-danger">
                            ...
                            @role('admin|medical_station')
                                <a href="{{ route('manager.vitamin-a.dashboard', [
                                    ...
                                    ]) }}" id="btnVitaminA" class="small-box-footer">Trang chủ 
